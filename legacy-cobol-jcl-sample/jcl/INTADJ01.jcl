//TRDADJ01 JOB (ACCT),'TRD DELTA',CLASS=A,MSGCLASS=X,NOTIFY=&SYSUID
//* ------------------------------------------------------------------
//*  SAMPLE JOB: COMPILE & EXECUTE TRADE ADJUSTMENT PROGRAM
//* ------------------------------------------------------------------
// SET COBPROG=TRDADJ
// SET LOADLIB=&&LOADSET
// SET SRCLIB=&&SRCLIB
...
//SYSPRINT DD  SYSOUT=*
//SYSIN    DD  DUMMY
//SYSUT1   DD  DISP=SHR,DSN=LEGACY.TRD.SRC
//SYSUT2   DD  DISP=OLD,DSN=&SRCLIB(&COBPROG)
//CPYCPY   EXEC PGM=IEBGENER
//SYSPRINT DD  SYSOUT=*
//SYSIN    DD  DUMMY
//SYSUT1   DD  DISP=SHR,DSN=LEGACY.TRD.CPY(TRMAP)
//SYSUT2   DD  DISP=OLD,DSN=&COPYLIB(TRMAP)
//CPYDATA  EXEC PGM=IEBGENER
//SYSPRINT DD  SYSOUT=*
//SYSIN    DD  DUMMY
//SYSUT1   DD  DISP=SHR,DSN=LEGACY.TRD.DATA(TRLOG)
//SYSUT2   DD  DISP=OLD,DSN=&DATALIB(TRLOG)
//********************************************************************
...
//SYSPRINT DD  SYSOUT=*
//********************************************************************
//* STEP 5: EXECUTE PROGRAM (REPORT TRADE ADJUSTMENTS)
//********************************************************************
//RUN      EXEC PGM=&COBPROG
//STEPLIB  DD  DISP=SHR,DSN=&LOADLIB
//TRDIN    DD  DISP=SHR,DSN=&DATALIB(TRLOG)
//REPORT   DD  SYSOUT=*
//SYSOUT   DD  SYSOUT=*
//SYSIN    DD  DUMMY
//* ------------------------------------------------------------------
